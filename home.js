const daisyP1 = new Path2D(
  ...
  function onClick(e) {
    ...
    currentWinds.push({
      wind: Math.random() * 2 - 1, // Random wind direction between -1 and 1
      posX: mouseX,
      posY: mouseY,
      speed: 3000 / 2000, // Wind speed
      speedUp: 0, // Wind speed increase
      powerUp: -2 / 1000, // Wind power decrease
  ...
  function onMouseMove(event) {
    ...
    const inRange = event.clientY > canvasHeight;
    if (inRange) {
